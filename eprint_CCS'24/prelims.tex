...
is equivalent (except with a negligible probability) to a real pairing check $(a\cdot T_1)\cdot (T_2\cdot b)=0$ where $a$ and $b$ denoting vectors in $\F$ encoding polynomials in $R_1$ and $R_2$ in
