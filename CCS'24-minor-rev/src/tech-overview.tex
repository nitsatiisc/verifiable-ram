...
assume $T=(\vec{I}_n,\vecT)$ with $\vec{I}_n=(1,2,\ldots,n)$. In this case we have $T[i]=\vecT[i]$.
...
\begin{table*}[bt]
    \begin{tabular}{l|l|l|l|l}
        ...
        \rowcolor{gray}
        \textcolor{white}{Batching-Efficient RAM}                                                                          & \textcolor{white}{Fig  ~\ref{fig:complete-listing}}    & \textcolor{white}{$\widetilde{O}(\sqrt{mN})\,\F,\G$}            & \textcolor{white}{8P}            & \textcolor{white}{$65\Gone$, $1\Gtwo$, $43\F$}  \\ \hline
    \end{tabular}
