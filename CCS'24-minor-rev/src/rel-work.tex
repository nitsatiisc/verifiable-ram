...
\begin{table*}[tb!]
	\begin{tabular}{|llll|}
		...
		\multicolumn{1}{|l|}{OWWB20~\cite{USENIX:OWWB20}} & \multicolumn{1}{l|}{$O(1)$} & \multicolumn{1}{l|}{$\wt{O}(m+N)$} & $O(1)$\\ \hline
		\multicolumn{1}{|l|}{B-INS-ARISA~\cite{CCS:CFHKKO22}} & \multicolumn{1}{l|}{$O(1)$} & \multicolumn{1}{l|}{$\wt{O}(m+N)$} & $O(1)$ \\ \hline
		\multicolumn{1}{|l|}{\begin{tabular}[c]{@{}l@{}}Our work\\ (c.f. Table ~\ref{tbl:efficiency-components})\end{tabular}} & \multicolumn{1}{l|}{$65\Gone,\, 1\Gtwo,\, 43\F$} & \multicolumn{1}{l|}{$\wt{O}(\sqrt{mN})\, \F,\Gone$} & $8P$ \\ \hline
	\end{tabular}
