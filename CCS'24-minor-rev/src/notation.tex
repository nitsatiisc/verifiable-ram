...
\newcommand{\evalV}[1]{\ensuremath{{#1}_{|_\setV}}}
\newcommand{\evalN}[1]{\ensuremath{{#1}_{|_\setN}}}
...
\newcommand{\RSVEC}{\ensuremath{\mathcal{R}^{\mathsf{subvec}}_{\srs,N,m}}}
...
\newcommand{\subvecprover}{\prover_{\mathsf{sv}}}
\newcommand{\subvecverifier}{\verifier_{\mathsf{sv}}}
\newcommand{\argoutput}[4]{\langle {#1}({#3}), {#2}\rangle({#4})}
