...
Then, for any $I\subseteq [N]$, there exists an algorithm to compute $\gany{Q}$ as given in Equation ~\eqref{eq:enc-quotient}
...
\begin{proof}
    ...
    Let $d_j:=\xi^j \Delta t_j$. Recall how $a_i$ and $b_j$ were defined:\\
    \begin{gather}\label{eq:scalars}
