...
A committed lookup argument is a succinct argument of knowledge for the relation $\RLOOK$. \chaya{by defn, in the NI case, the prover is allowed to come up with an adversarial instance, in this case all commitments.}