...
\chaya{Moumita: compare with Caulk+, CQ}
Lasso~\cite{lasso} new family of lookup arguments where the prover's cost only grows with table entries that are
