\begin{figure}[t!]
    ...
    \end{tikzpicture}
    \caption{Comparison of Constraints incurred by different approaches for batching RAMs.}
...
\begin{figure}[t!]
    ...
    \begin{tikzpicture}
        \begin{axis}[
        title={Batching Efficient RAM from CQ},
        xmin=0,
        xmax=9,
        ymin=0,
        ymax=200,
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Performance of Batching RAM with updates}
