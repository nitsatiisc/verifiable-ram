...
%	\renewcommand{\shortauthors}{Trovato et al.}
	...
	\begin{abstract}
		...
		proving a batch of $m$ updates on a RAM of size $N$ incurring a cost sublinear in $N$.
...
%	
	...
	\keywords{Succinct Arguments, efficient RAM, indexed lookups}
...
inherent in recent works on batching-efficient RAM using RSA accumulators ~\cite{CCS:CFHKKO22}.
