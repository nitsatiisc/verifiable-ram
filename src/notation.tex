...
\newcommand{\RAM}[2]{\ensuremath{\mathsf{RAM}}(\F, \mathcal{#1}, {#2})}
\newcommand{\RAMOp}[1]{\ensuremath{\mathsf{ROP}}(\F, \mathcal{#1})}
\newcommand{\Rupd}[1]{\ensuremath{\mathsf{Upd}_{\mathcal{#1}}}}
\newcommand{\LRAM}[3]{\ensuremath{\mathcal{L}_{\mathsf{RAM}}(\F,\mathcal{#1},#2,#3)}}
...
% group encodings
\newcommand{\gone}[1]{\ensuremath{[#1]_1}}
\newcommand{\gtwo}[1]{\ensuremath{[#1]_2}}
